...
1.  **Clone the repository**:
    ```bash
    git clone https://github.com/Anisha-Chhajer-Jain/Assignment-Sem-2.git
    cd Assignment-1
    ```
...
[Postman API Documentation](https://documenter.getpostman.com/view/50840681/2sBXqDsNhb)
